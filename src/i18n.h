...
enum class StrId {
    ...
    ErrZiyuNotRunning, ErrZiyuSendFailed,
    ErrPlayerConfigMissing, ErrPlayerVideoNotFound, ErrPlayerLaunchFailed,
    ...
    PrefFadeAnimation, PrefShowOsd, PrefAskDelete, PrefPreserveZoom, PrefAutoMonitorPlacement, PrefListLoop,
